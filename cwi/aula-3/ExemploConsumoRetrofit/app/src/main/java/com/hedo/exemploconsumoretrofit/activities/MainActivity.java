...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, MoviePreviewAdapter.OnItemClickListener, Callback<MovieSearchByNameResponse> {
    ...
    private void initializeRecyclerView() {
        ...
        moviePreviewAdapter = new MoviePreviewAdapter(moviePreviews, this);
    ...
    public void onItemClick(MoviePreview moviePreview) {
        ...
        intent.putExtra("teste", moviePreview);

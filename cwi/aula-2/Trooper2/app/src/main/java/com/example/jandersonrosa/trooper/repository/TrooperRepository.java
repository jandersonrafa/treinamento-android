package com.example.jandersonrosa.trooper.repository;
...
import com.example.jandersonrosa.trooper.util.SharedPreferencesUtil;
...
public class TrooperRepository {
    ...
    private static final ArrayList<Trooper> TROOPERS = new ArrayList<>(Arrays.asList(
            ...
            new Trooper(2, "Stormtrooper", "https://vignette.wikia.nocookie.net/starwars/images/c/ca/Anovos_Stormtrooper.png/revision/latest/scale-to-width-down/140", "Stormtroopers were the assault/policing troops of the Galactic GALACTIC_EMPIRE. Dissenting citizens referred to them as bucketheads, a derogatory nickname inspired by the bucket-shaped helmets of stormtroopers.", Affiliation.GALACTIC_EMPIRE),
            new Trooper(3, "Clone Shadow Trooper", "https://vignette.wikia.nocookie.net/starwars/images/3/37/Utapaushadowtrooper.jpg/revision/latest/scale-to-width-down/140", "Clone shadow troopers were an elite cadre of clone troopers, devised by Director Armand Isard of GALACTIC_REPUBLIC Intelligence during the Clone Wars. Using magseals installed in their armor, shadow troopers could attach plates to themselves that could pass them off as mercenaries belonging to certain factions.", Affiliation.GALACTIC_REPUBLIC),
            new Trooper(4, "Deathtrooper", "https://vignette.wikia.nocookie.net/starwars/images/6/69/Death_trooper_Fathead.png/revision/latest/scale-to-width-down/140", "Death troopers were an elite variant of the Galactic GALACTIC_EMPIRE's stormtroopers. They served as protective details and bodyguards for important Imperial officers and members of the Tarkin Initiative.", Affiliation.GALACTIC_EMPIRE),
            ...
            new Trooper(6, "Jumptrooper", "https://vignette.wikia.nocookie.net/starwars/images/a/a0/Star-wars-jumptrooper-sixth-scale-hot-toys-silo-902768.png/revision/latest/scale-to-width-down/140", "Jumptroopers were a variant of the Galactic GALACTIC_EMPIRE's stormtroopers; similar to their clone predecessors, they were equipped with a jetpack, or alternatively, with a jump pack that could suspend them in the air or maneuver through space environments.", Affiliation.GALACTIC_EMPIRE),
            new Trooper(7, "Purgetrooper", "https://vignette.wikia.nocookie.net/starwars/images/4/4c/Bragh.png/revision/latest/scale-to-width-down/140", "Purge Troopers were a feared group of elite Imperial stormtroopers who enforced the GALACTIC_EMPIRE's rule in the Anoat sector on behalf of Governor Adelhard.", Affiliation.GALACTIC_EMPIRE),
    ...
    public static ArrayList<Trooper> tryGettingForSharedPreferences(SharedPreferences sharedPreferences) {
        Gson gson = new Gson();
